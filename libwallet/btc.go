...
func (mgr *AssetsManager) CreateNewBTCLightningWallet(walletName, privatePassphrase string, privatePassphraseType int32) error {
	return mgr.LightningService.InitWallet(privatePassphrase)
}
